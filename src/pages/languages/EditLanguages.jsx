...
function EditLanguages({ language, fetchData }) {
  const [showEditModal, setShowEditModal] = useState(false);
  const [editedTitle, setLocalEditedTitle] = useState(language.title);
