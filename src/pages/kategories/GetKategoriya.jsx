...
import EditKategoriya from "./EditKategoriya";
import DeleteKategoriya from "./DeleteKategoriya";
import ShowKategoriya from "./ShowKategoriya";
import PostKategoriya from './PostKategoriya'
  ...
  return (
    <>
      <div className="mt-[8px] rounded-lg md:container mx-auto md:mt-10 flex min-h-[840px] min-w-full max-w-screen-lg flex-col gap-8 bg-white shadow-2xl">
        ...
        <PostKategoriya handleClick={handleClick} fetchData={fetchData} />
        ...
        <ShowKategoriya setOpen={setOpen} open={open} />
      </div>
    </>
  );
}

export default GetKategoriya;
