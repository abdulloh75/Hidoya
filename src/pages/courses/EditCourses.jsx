...
function EditCourses({ courses, fetchData }) {
  const [showEditModal, setShowEditModal] = useState(false);
  const [editedTitle, setLocalEditedTitle] = useState(courses.title);
  ...
  const OnEdit = async () => {
    try {
      ...
      toast.success("Kurs tahrirlandi", {
      ...
      toast.error("Kurs tahrirlanmadi", {
        position: toast.POSITION.TOP_RIGHT,
      });
    } finally {
      setLoading(false);
