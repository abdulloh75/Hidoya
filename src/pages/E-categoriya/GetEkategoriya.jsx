...
import EditEkategoriya from "./EditEkategoriya";
import DeleteEkategoriya from "./DeleteEkategoriya";
import ShowEkategoriya from "./ShowEkategoriya";
import PostEkategoriya from './PostEkategoriya'
import Loading from "../loading/Loading";
import { BiShow } from "react-icons/bi";
import { Button, } from 'antd';

function GetEkategoriya() {
  ...
  return (
    <>
      <div className="mt-[8px] rounded-lg md:container mx-auto md:mt-10 flex min-h-[840px] min-w-full max-w-screen-lg flex-col gap-8 bg-white shadow-2xl">
        ...
        <PostEkategoriya handleClick={handleClick} fetchData={fetchData} />
        ...
        <ShowEkategoriya setOpen={setOpen} open={open} />
      </div>
    </>
  );
}

export default GetEkategoriya;
