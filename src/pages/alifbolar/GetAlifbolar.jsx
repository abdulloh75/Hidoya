...
import EditAlifbolar from "./EditAlifbolar";
import DeleteAlifbolar from "./DeleteAlifbolar";
import ShowAlifbolar from "./ShowAlifbolar";
import PostAlifbolar from './PostAlifbolar'
import Loading from "../loading/Loading";
import { BiShow } from "react-icons/bi";
import { Button, } from 'antd';

function GetAlifbolar() {
  ...
  return (
    <>
      <div className="mt-[8px] rounded-lg md:container mx-auto md:mt-10 flex min-h-[840px] min-w-full max-w-screen-lg flex-col gap-8 bg-white shadow-2xl">
        ...
        <PostAlifbolar handleClick={handleClick} fetchData={fetchData} />
        ...
        <ShowAlifbolar setOpen={setOpen} open={open} />
      </div >
    </>
  );
}

export default GetAlifbolar;
