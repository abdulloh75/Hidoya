...
const ShowAlifbolar = ({ setOpen, open }) => {
  return (
    <>
      <div>
        <Modal
        ...
        >
          <div
            className="w-[310px] mt-5 rounded-lg md:flex md:mt-5 md:w-[27rem] items-center justify-evenly border-2 border-[#dee2e6] p-2"
            key={open?.data?.id}
          >
